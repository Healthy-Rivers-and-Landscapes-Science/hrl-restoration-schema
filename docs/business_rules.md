...
| Program-assigned fields such as [`project_id`](reference/project_id.md) should be assigned after validation and ingestion | Ingestion code | Derived value | Submitters should not provide these fields in the submission profile |
